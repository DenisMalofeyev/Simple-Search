...
<head>
    ...
    <link rel="stylesheet" href="{THEME}/keyboard/styles00.css" type="text/css" />
    <script type="text/javascript" src="{THEME}/keyboard/global00.js" charset="utf-8"></script>
...
<div id="main">
	...
	<div id="search">
<form action="images" method="get" name="aport_search">
			...
			<div id="search_c_2">
				...
				<div id="search_c_2_2">
					<table style="width:100%;">
						<tr>
							<td style="vertical-align:top;"> <input type="hidden" name="search"> <input type="text" name="phrase"  class="search_box"  id="query" size="40"    columns="2" autocomplete="off"  delay="1500" ></td>
