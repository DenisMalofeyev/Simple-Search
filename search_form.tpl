...
<head>
    ...
    <script src="./templates/default/images/qlook000.js" language="JavaScript"></script>
</head>
...
function set_this(search_link)
{
	...
	document.getElementById('search_ar_'+arid[1]).innerHTML = '<img src="./templates/default/images/ar_1.png" alt="" />';
}
</script>
 ...
 <td><a id="search_link_2" href="search_img.php" title="{text_img}">{text_img}</a></td><td>&#160;&#160;|&#160;&#160;</td>
				...
				<div id="search_c_2_2">
					<table style="width:100%;">
						<tr>
							<td style="vertical-align:top;"> <input type="text" name="query" value="{query}"  class="search_box"  id="query" size="40"   action="include/js_suggest/suggest.php" columns="2" autocomplete="off"  delay="1500" ></td>
...
<center>
<table width="70%" border="0" style="background-color:#d9e3e6;" align="center" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr>
    <td align="left"><img src="templates/default/images/200.png" width="21" height="21"></td>
    <td width="49%" align="right"><img src="templates/default/images/300.png" width="21" height="21"></td>
  </tr>
</table>
  </center>
